...
for f = 1:length(fields)
    for idx = [1:2 4:length(raw_data.(fields{f}))]
...
valid_list = [1:10 12:14 16:length(raw_data.total.force)];
...
force_for_paper = subject3_KPNP_force(idx,1);

x = 0:1/2000:1/2000*300;
